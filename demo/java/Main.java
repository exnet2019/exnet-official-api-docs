...
//            System.out.println(CertificateUtil.sign(request_str.getBytes("UTF-16LE"), ssl_file, "证书密码"));
            ...
            String res = HttpRequest.post("https://api.exnet.io/pie/api/base/secret/v1/assetsList")
    ...
    private static String get_timestamp() {
        String res = HttpRequest.get("https://api.exnet.io/pie/api/base/secret/v1/time")
